...
class HomeController extends Controller {
    ...
    public function product_details($url_slug) {
        ...
        $category_id = DB::table('categories')->where('category_id', $product_info->subcategory_id)->where('category_status', 'active')->first('fk_category_id')->fk_category_id;
        $category_name = DB::table('categories')->where('category_id', $category_id)->first('category_name')->category_name;

        $subcategory_id = DB::table('categories')->where('category_id', $product_info->item_id)->where('category_status', 'active')->first('fk_category_id')->fk_category_id;
        $subcategory_name = DB::table('categories')->where('category_id', $subcategory_id)->first('category_name')->category_name;
