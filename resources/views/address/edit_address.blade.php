    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2 style="margin-bottom:10px !important;">Edit The Address</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ URL::to('/address') }}" class="btn btn-simple btn-sm btn-info btn-filter"><i class="fa fa-list-ul"></i><span>&nbsp;All Address</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{ URL::to('/update_address') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="title" value="{{ $address->title }}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
