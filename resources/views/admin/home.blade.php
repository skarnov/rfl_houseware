<div id="main-content">
    ...
    <div class="text-center">
        <img src="{{ URL('/assets/images/login-bg.png') }}" style="width:100%;" class="img-responsive"/>
    </div>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ URL('/assets/images/xs/avatar1.jpg') }}" class="rounded-circle width35" alt=""></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL('/assets/images/xs/avatar2.jpg') }}" class="rounded-circle width35" alt=""></td>
                                            <td>Susie Willis</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL('/assets/images/xs/avatar3.jpg') }}" class="rounded-circle width35" alt=""></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL('/assets/images/xs/avatar4.jpg') }}" class="rounded-circle width35" alt=""></td>
                                            <td>Erin Gonzales</td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL('/assets/images/xs/avatar5.jpg') }}" class="rounded-circle width35" alt=""></td>
                                            <td>Ava Alexander</td>
                                            <td><span>UI UX Designer</span></td>
                                            <td><span class="badge badge-success">Good</span></td>
                                            <td><span class="sparkbar">5,8,6,3,5,9,-2</span></td>
