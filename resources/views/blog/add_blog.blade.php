    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2 style="margin-bottom:10px !important;">Add New Blog</h2>
                    <ul class="breadcrumb">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{url('/save_blog')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Blog</label>
                                        <textarea name="blog" class="form-control blog">{{ old('blog') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
