        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2 style="margin-bottom:10px !important;">All Video Albums</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ URL::to('/add_video_album') }}" class="btn  btn-simple btn-sm btn-info btn-filter"><i class="fa fa-plus-square"></i><span>&nbsp;Add Video Album</span></a></li> 
                    </ul>
                </div>            
            </div>
        </div>
                            ...
                            <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view_video_album/{{ $album->content_id }}" class="btn btn-sm btn-outline-primary" title="View"><i class="icon-eye"></i></a>
                                            <a href="edit_video_album/{{ $album->content_id }}" class="btn btn-sm btn-outline-success" title="Edit"><i class="icon-pencil"></i></a>
        ...
        $(document).on("click", ".show-alert", function (e) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result == true) {
                        window.location.href = "{{ URL::to('/delete_video_album/') }}/" + id;
                    }
                }
            });
        });
