    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2 style="margin-bottom:10px !important;">Add New Brand & Partner</h2>
                    <ul class="breadcrumb">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{url('/save_featured')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pages" class="form-control">
                                            <option value="our-brands">Our Brands</option>
