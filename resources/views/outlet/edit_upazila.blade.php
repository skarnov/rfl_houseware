    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="body">
                        <form id="basic-form" method="POST" action="{{ URL::to('/update_upazila') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <input type="hidden" name="id" value="{{ $upazilas->id }}" class="form-control">
                                    <div class="form-group">
                                        <label for="inputState">Districts</label>
                                        <select name="districts_id" id="inputState" class="form-control">
                                            <option value="{{ $upazilas->district_id }}">Choose District</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" required value="{{ $upazilas->name }}" class="form-control">
                                        </div>
