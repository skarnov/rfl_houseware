            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="body">
                        ...
                        <form id="basic-form" method="POST" action="{{ URL::to('/save_social') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="icon_class" required  class="form-control">
                                    </div>
                             
                                    <div class="form-group">
                                        <label>URL</label>
                                        <input type="text" name="website_url" required value="" class="form-control">
                                    </div>
