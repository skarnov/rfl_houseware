        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2 style="margin-bottom:10px !important;">All Categories</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ URL::to('/add_category') }}" class="btn  btn-simple btn-sm btn-info btn-filter"><i class="fa fa-plus-square"></i><span>&nbsp;Add Category</span></a></li> 
                    </ul>
                </div>            
            </div>
        </div>
                ...
                <div class="card">
                    <div class="body">
                        <div class="table-responsive">
                            <span>
                                Displaying Categories <strong>from {{ $all_categories->firstItem() }} to {{ $all_categories->lastItem() }}</strong> out of total <strong>{{ $all_categories->total() }}</strong>
                            </span><hr />
                            <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span> {{ $category->category_serial }}</span></td>
                                        <td>
        ...
        $(document).on("click", ".show-alert", function (e) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result == true) {
                        window.location.href = "{{ URL::to('/delete_category/') }}/" + id;
                    }
                }
            });
        });
