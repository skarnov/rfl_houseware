...
<section class="page-header">
    <div class="container">
        <div class="page-header-content">
            <h3>Store Locator - Carniva</h3>
            <p>{{ $page_info->page_short_description }}</p>
        </div>
        <ul class="breadcrumb">
            <li><a href="{{ URL('/') }}">Home</a></li>
            <li><a href="{{ URL('/carnivaoutlets') }}">Carnivay</a></li>
        </ul>
    </div>
</section>
<!-- page header end -->
                ...
                <form action="#">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="division_list" class="select" id="division_list3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="w-100" name="district_list" id="district_list3">
                                <option selected data-display="Select District">Select District</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="">Upazila</label>
                            <select class="w-100" name="upazila_list" id="upazila_list3">
            ...
            <div class="row news-warp" id="showroom">
                <div class="col-md-4">
                    <div class="showroom-list">
                        <h5>Showrooms</h5>
                        <div id="showrooms3" class="contentreloader"></div>
                    </div>   
                </div>
                <div class="col-md-8">
                    <div id="locatmap3" class="map-details"></div>
                </div>
            </div>
